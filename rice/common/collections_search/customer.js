// Easy search
EasySearch.createSearchIndex('rice_customerSearch', {
  collection: Rice.Collection.Customer, // instanceof Meteor.Collection
  ...
  query: function(searchString, opts) {
    ...
    var query = EasySearch.getSearcher(this.use).defaultQuery(this,
      searchString);
